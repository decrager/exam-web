        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Ketersediaan Amplop</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('data.amplop.update', $ujian?->Amplop?->id) }}" method="POST" class="btn-group" role="group">
                                                ...
                                                @csrf
                                                @method('PUT')
                                                <button type="submit" class="btn btn-success btn-sm" onclick="return confirm('Yakin ingin mengubah status Print?')"><i class="fas fa-check"></i></button>
                                            </form>
                                        </td>
                                        <td>
