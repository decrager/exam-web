        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Tambah Program Studi</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="">Beranda</a></li>
                        <li><a><span>Akademik</span></a></li>
                        <li><a href=""><span>Program Studi</span></a></li>
                            ...
                            <div class="card-body">
                                <form action="{{ route('data.prodi.create') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Ketik..." name="kode_prodi"
                                            id="kode_prodi" />
                                    </div>

                                    <div class="form-group">
                                        <label for="nama_prodi" class="col-form-label">Nama Program Studi</label>
                                        <input class="form-control" type="text" placeholder="Ketik..." id="nama_prodi" name="nama_prodi" />
                                    </div>
