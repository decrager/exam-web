                            ...
                            <div class="card-body">
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Ketik..." value="{{ $prodi->nama_prodi }}" name="kode_prodi"
                                            id="kode_prodi" />
                                    </div>

                                    <div class="form-group">
                                        <label for="nama_prodi" class="col-form-label">Nama Program Studi</label>
                                        <input class="form-control" type="text" placeholder="Ketik..." id="nama_prodi" value="{{ $prodi->kode_prodi }}" name="nama_prodi" />
                                    </div>
