    ...
    <div class="user-profile pull-right">
        ...
        <div class="dropdown-menu">
            <form action="{{ route('resetView') }}" method="GET">
                <button type="submit" class="dropdown-item"><a class="dropdown-item">Ubah Password</a></button>
            </form>
            {{-- <button class="dropdown-item">Ubah Password</button>
            <a class="dropdown-item" href="{{ route('resetPassword') }}">Ubah Password</a> --}}
            <form action="/logout" method="POST">
                @csrf
                <button type="submit" class="dropdown-item"><a class="dropdown-item">Keluar</a></button>
            </form>
        </div>
    </div>
</div>
