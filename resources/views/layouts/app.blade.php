...
<head>
    ...
    @if (Request::routeIs('pjLokasi.pengawas.absensi.export') || Request::routeIs('pjUjian.kelengkapan.berkas.ttd') || Request::routeIs('pjLokasi.soal.form') || Request::routeIs('berkas.kelengkapan.berkas.ttd') || Request::routeIs('pjSusulan.mahasiswa.form') || Request::routeIs('pengawas.absensi.ttd'))
