                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('pjUjian.serahterima.destroy', $ujian?->Berkas?->id) }}" method="POST" class="btn-group" role="group">
                                                    <a class="btn btn-success @if($ujian?->Berkas?->file == null) disabled @endif" href="{{ Storage::files('storage/files/pdf/' . $ujian?->Berkas?->file) }}" target="_blank"><i class="fas fa-download"></i></a>
                                                    @csrf
                                                    @method('PUT')
